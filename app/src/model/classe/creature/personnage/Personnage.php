...
class Personnage extends Creature {
    ...
    //Compétence :
    protected $comp_manoeuvreetmouvement_sansarmure_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_manoeuvreetmouvement_cuirsouple_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_manoeuvreetmouvement_cuirrigide_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_manoeuvreetmouvement_cottedemaille_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_manoeuvreetmouvement_plate_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];

    protected $comp_arme_tranchantunemain_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_arme_contondantunemain_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_arme_deuxmains_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_arme_armedelance_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_arme_projectile_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_arme_armedhast_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];

    protected $comp_generale_escalade_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_generale_equitation_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_generale_natation_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_generale_pistage_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];

    protected $comp_subterfuge_embuscade_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_subterfuge_filatdissim_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_subterfuge_crochetage_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_subterfuge_desarmementdepiege_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];

    protected $comp_magie_lecturederune_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_magie_utilisationdobjet_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_magie_directiondesort_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    
    protected $comp_physique_developcorporel_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    protected $comp_physique_perception_total = ['val' => 0, 'experience' => 0, 'niveau' => 1];
    ...
    public function insert_personnage_comp() 
    {
        ...
        $comp['comp_manoeuvreetmouvement_sansarmure_total_experience'] = $this->comp_manoeuvreetmouvement_sansarmure_total['experience'];
        ...
        $comp['comp_manoeuvreetmouvement_cuirsouple_total_experience'] = $this->comp_manoeuvreetmouvement_cuirsouple_total['experience'];
        ...
        $comp['comp_manoeuvreetmouvement_cuirrigide_total_experience'] = $this->comp_manoeuvreetmouvement_cuirrigide_total['experience'];
        ...
        $comp['comp_manoeuvreetmouvement_cottedemaille_total_experience'] = $this->comp_manoeuvreetmouvement_cottedemaille_total['experience'];
        ...
        $comp['comp_manoeuvreetmouvement_plate_total_experience'] = $this->comp_manoeuvreetmouvement_plate_total['experience'];
        ...
        $comp['comp_arme_tranchantunemain_total_experience'] = $this->comp_arme_tranchantunemain_total['experience'];
        ...
        $comp['comp_arme_contondantunemain_total_experience'] = $this->comp_arme_contondantunemain_total['experience'];
        ...
        $comp['comp_arme_deuxmains_total_experience'] = $this->comp_arme_deuxmains_total['experience'];
        ...
        $comp['comp_arme_armedelance_total_experience'] = $this->comp_arme_armedelance_total['experience'];
        ...
        $comp['comp_arme_projectile_total_experience'] = $this->comp_arme_projectile_total['experience'];
        ...
        $comp['comp_arme_armedhast_total_experience'] = $this->comp_arme_armedhast_total['experience'];
        ...
        $comp['comp_generale_escalade_total_experience'] = $this->comp_generale_escalade_total['experience'];
        ...
        $comp['comp_generale_equitation_total_experience'] = $this->comp_generale_equitation_total['experience'];
        ...
        $comp['comp_generale_natation_total_experience'] = $this->comp_generale_natation_total['experience'];
        ...
        $comp['comp_generale_pistage_total_experience'] = $this->comp_generale_pistage_total['experience'];
        ...
        $comp['comp_subterfuge_embuscade_total_experience'] = $this->comp_subterfuge_embuscade_total['experience'];
        ...
        $comp['comp_subterfuge_filatdissim_total_experience'] = $this->comp_subterfuge_filatdissim_total['experience'];
        ...
        $comp['comp_subterfuge_crochetage_total_experience'] = $this->comp_subterfuge_crochetage_total['experience'];
        ...
        $comp['comp_subterfuge_desarmementdepiege_total_experience'] = $this->comp_subterfuge_desarmementdepiege_total['experience'];
        ...
        $comp['comp_magie_lecturederune_total_experience'] = $this->comp_magie_lecturederune_total['experience'];
        ...
        $comp['comp_magie_utilisationdobjet_total_experience'] = $this->comp_magie_utilisationdobjet_total['experience'];
        ...
        $comp['comp_magie_directiondesort_total_experience'] = $this->comp_magie_directiondesort_total['experience'];
        ...
        $comp['comp_physique_developcorporel_total_experience'] = $this->comp_physique_developcorporel_total['experience'];
        ...
        $comp['comp_physique_perception_total_experience'] = $this->comp_physique_perception_total['experience'];
