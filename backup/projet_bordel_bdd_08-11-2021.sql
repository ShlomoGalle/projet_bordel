...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 08 nov. 2021 à 18:54
...
(2, 1, NULL, 'L\'Arsenal du Chasseur', 'magasin', 3000000),
(3, 1, NULL, 'La Salamandre Chantante', 'magasin', 3000000),
...
(1, NULL, '1_minastirith.png', '<map name=\"image-map\"> <area alt=\"taverne\" title=\"taverne\" href=\"\" coords=\"406,483,376,453,391,435,425,467\" shape=\"poly\" onclick=\"click_on_img(\'taverne\', 1)\"> <area alt=\"magasin d\'arme\" title=\"magasin d\'arme\" href=\"\" coords=\"399,404,379,387,413,353,431,371\" shape=\"poly\" onclick=\"click_on_img(\'marchand\', 2)\"> <area alt=\"magasin d\'armure\" title=\"magasin d\'armure\" href=\"\" coords=\"471,367,490,349,519,382,500,399\" shape=\"poly\" onclick=\"click_on_img(\'marchand\', 3)\"> <area alt=\"plaine de minas tirith\" title=\"plaine de minas tirith\" href=\"\" onclick=\"click_on_img(\'exterieur\', 2)\" coords=\"3,438,73,469,79,487,93,495,112,587,186,700,295,768,411,826,411,806,417,795,469,794,489,810,489,824,603,764,705,680,773,571,797,445,802,419,892,415,891,897,4,897\" shape=\"poly\"> </map>', 'ville', NULL, 1, 1, 1),
...
INSERT INTO `personnage_identite` (`id`, `nom`, `race`, `taille`, `age`, `poids`, `cheveux`, `yeux`, `signe_particulier`, `id_carte_actuelle`, `argent`, `point_de_pouvoir`, `point_de_vie`, `jr_essence_total`, `jr_theurgie_total`, `jr_poison_total`, `jr_maladie_total`, `date_creation`, `bool_mort`) VALUES
